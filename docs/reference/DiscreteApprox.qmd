# DiscreteApprox { #pyratapprox.DiscreteApprox }
...
| Name | Description |
| --- | --- |
| [getfunction](#pyratapprox.DiscreteApprox.getfunction) | Get the underlying rational function. |
| [isapprox](#pyratapprox.DiscreteApprox.isapprox) | Check if this approximation is close to another function. |
| [nodes](#pyratapprox.DiscreteApprox.nodes) | Get the interpolation nodes of the approximation. |
| [testpoints](#pyratapprox.DiscreteApprox.testpoints) | Get the test points used to validate the approximation. |
| [values](#pyratapprox.DiscreteApprox.values) | Get the function values at the interpolation nodes. |

### getfunction { #pyratapprox.DiscreteApprox.getfunction }
...
### isapprox { #pyratapprox.DiscreteApprox.isapprox }
...
### nodes { #pyratapprox.DiscreteApprox.nodes }
...
### testpoints { #pyratapprox.DiscreteApprox.testpoints }
...
### values { #pyratapprox.DiscreteApprox.values }
