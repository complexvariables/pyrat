...
```{python}
r_scipy = spAAA(x, f)
r_aaa = approximate(f, x, AAA)
r_tcf = approximate(f, x, TCF)
print("Degrees:")
...
time_aaa = timeit.timeit('approximate(f, x, AAA)', globals=globals(), number=n) / n
time_tcf = timeit.timeit('approximate(f, x, TCF)', globals=globals(), number=n) / n
